/**
 * DropdownMenu Component - Radix UI Primitive + CVA
...
const dropdownMenuItemVariants = cva(
  'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
  {
    variants: {
      variant: {
        default: 'hover:bg-white/[0.08] focus:bg-green-500/20 focus:text-green-400',
        destructive: 'hover:bg-red-500/20 focus:bg-red-500/30 focus:text-red-400',
      },
    },
    defaultVariants: {
      variant: 'default',
...
const DropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span className={cn('ml-auto text-xs tracking-widest opacity-60 text-gray-500', className)} {...props} />
);
