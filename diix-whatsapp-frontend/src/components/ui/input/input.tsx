...
const inputVariants = cva(
  'w-full rounded-xl border backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-accent-primary/50 focus:border-accent-primary/50 transition-all duration-300 ease-out',
  {
    variants: {
      variant: {
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, label, error, icon, variant, size, type = 'text', ...props }, ref) => {
    return (
